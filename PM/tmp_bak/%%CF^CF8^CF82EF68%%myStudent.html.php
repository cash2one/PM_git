<?php /* Smarty version 2.6.26, created on 2013-06-06 17:12:15
...
<div class="wrap">
    <p class="mySkill-common">
        选择学生：<select class="studentlist" id="studentlist">
            ...
            for (var key in skillArray) {
            	...
            	var content =
                    "<tr>" +
                    		...
                    		"</td>" +
                    		"<td class=\"tleft\">" +
                				skillArray[key].skill_exp+ "/100"　+
                			"</td>" +
                            "<td class=\"bright\">" +
                            	skillArray[key].skill_lv+ 
                            "</td>" +
                    "</tr>";
            	$(content).insertAfter($("#table1 tr:eq(" + serial + ")"));
            }
