<?php /* Smarty version 2.6.26, created on 2013-06-08 10:56:19
        ...
        $("#skill-add-btn").click(function () {
            ...
            $.ajax({
                ...
                success:function (data) {
                    ...
                    var str = '<tr class="skill-name"><td class="bleft">' + skill_name + '</td><td class="tleft">暂缺</td><td class="tleft">暂缺</td><td class="tleft"><a class="minus-skill-lv" data-pgstuid="'+JSON.parse(data).pgstuid+'">-</a><span class="skill-lv-num">' + skill_lv + '</span><a class="add-skill-lv" data-pgstuid="'+JSON.parse(data).pgstuid+'">+</a></td><td class="bright"><a href="#"  class="sure-del-btn" data-pgstuid=' + JSON.parse(data).pgstuid + '>删除</a></td></tr>';
                    $(".table3").append(str);
                },
                error:function () {
                    alert('出错了！')
