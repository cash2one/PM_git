<?php /* Smarty version 2.6.26, created on 2013-06-27 17:51:23
         compiled from project/projectSkillSend.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'spUrl', 'project/projectSkillSend.html', 30, false),array('modifier', 'default', 'project/projectSkillSend.html', 59, false),)), $this); ?>
<!DOCTYPE html>
<html lang="zh"> 
<head>
...
" maxlength="200" class="itext stitle"  disabled="true "/></dd>
					<dt class="ps">项目备注</dt>
					<dd class="ps_data"><textarea name="proj_ps" id="proj_ps" class="itext" style="width:350px;height:100px" disabled="true "><?php echo $this->_tpl_vars['rs']['proj_ps']; ?>
</textarea></dd>
				</dl>
	         </div>
