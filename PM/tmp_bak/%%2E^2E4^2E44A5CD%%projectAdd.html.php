<?php /* Smarty version 2.6.26, created on 2013-07-03 09:39:36
...
"/>
				<input name="parent_proj" type="hidden" value="<?php echo $this->_tpl_vars['p_proj_id']; ?>
"/>
			</dl>
    ...
    $.ajax({
        ...
        success:function (data) {
        	...
        	for (var key in mtpl_flow) {
				...
				//产出物
				$(pnode_dd).find('input').eq(1).val((rs.flow_outcome==""?"0":rs.flow_outcome));
        	}
