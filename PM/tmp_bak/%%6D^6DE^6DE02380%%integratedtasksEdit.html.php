<?php /* Smarty version 2.6.26, created on 2013-07-01 18:43:59
         compiled from pg/admin/integratedtasksEdit.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'spUrl', 'pg/admin/integratedtasksEdit.html', 16, false),)), $this); ?>
<!DOCTYPE html>
...
" method="post" id="mtpl-form">
	...
	<table class="table_node" style="width: 680px;padding: 0;">
	  <tr>
	    ...
	    <td><span class="li2">
	      <input name="integrated_name" type="text" id="integrated_name" value="<?php echo $this->_tpl_vars['integrate']['integrated_tasks_name']; ?>
" maxlength="45"  datatype="Require" msg="综合任务模板名不能为空" class="itext stitle"/>
	      <input name="name="integrated_id" type="hidden" id="integrated_id" value="<?php echo $this->_tpl_vars['integrate']['integrated_tasks_id']; ?>
"> 
	    </span></td>
	  </tr>
	  <tr>
...
"><?php echo $this->_tpl_vars['rs1']['mtpl_name']; ?>
      ...
      <tr>
          ...
          <td><span class="li2">
              <textarea class="itext" style="resize: none;width: 436px;line-height: 24px;padding: .5em;" rows="5" id="integrated_desc"><?php echo $this->_tpl_vars['integrate']['integrated_tasks_desc']; ?>
</textarea>
          </span> </td>
      </tr>
	</table>
...
<?php $_from = $this->_tpl_vars['integratedChild']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['rs2']):
?>
addChildren(<?php echo $this->_tpl_vars['rs2']['integrated_child_id']; ?>
,<?php echo $this->_tpl_vars['rs2']['mtpl_id']; ?>
);
<?php endforeach; endif; unset($_from); ?>

$('#select_parent').val(<?php echo $this->_tpl_vars['integrate']['mtpl_id']; ?>
);
...
$(function(){
    ...
    $("#submit-btn").click(function(){
        ...
        var url='<?php echo $this->_plugins['function']['spUrl'][0][0]->__template_spUrl(array('c' => 'pgadmin','a' => 'integrated_tasks_edit_do'), $this);?>
';
