...
function file_get_html($url,$page_code, $use_include_path = false, $context=null, $offset = -1, $maxLen=-1, $lowercase = true, $forceTagsClosed=true, $target_charset = DEFAULT_TARGET_CHARSET, $stripRN=true, $defaultBRText=DEFAULT_BR_TEXT, $defaultSpanText=DEFAULT_SPAN_TEXT)
{
    ...
    //$contents = iconv($page_code, "utf-8//IGNORE",$contents);//juetion 乱码问题
...
class simple_html_dom
{
    ...
    protected function parse_charset()
    {
        ...
        if (empty($charset))
        {
            ...
            $charset = mb_detect_encoding($this->root->plaintext . "ascii", $encoding_list = array( "gbk","UTF-8", "CP1252" ) );
