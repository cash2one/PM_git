<?php /* Smarty version 2.6.26, created on 2013-07-30 14:12:29
...
" id="searchTab5">技</a>
		...
		<section class="boxstyle1 top proj_info">
			<h2 style="margin-bottom: 20px;"><span style="color:#000;font-family: georgia;font-size: 24px;">#<?php echo $this->_tpl_vars['rs']['proj_id']; ?>
:</span><?php echo $this->_tpl_vars['rs']['prod_name']; ?>
...
"/></dd>
                ...
                <dt>rd地址：</dt>
                <dd class="url"><a id="proj_rdUrl">[查]</a> <a href="<?php echo $this->_tpl_vars['rs']['proj_rdUrl']; ?>
" target="_blank"><?php echo $this->_tpl_vars['rs']['proj_rdUrl']; ?>
</a></dd>
				<dt>项目目标：</dt>
...
?>
				<?php if ($this->_tpl_vars['is_user'] == '1' || $this->_tpl_vars['rs']['user_id'] == $this->_tpl_vars['user_id'] || $this->_tpl_vars['rs']['respon_id'] == $this->_tpl_vars['user_id']): ?>
...
"><?php echo $this->_tpl_vars['pnod_state_list'][$this->_tpl_vars['rs']['pnod_state']]; ?>
				  ...
				  <?php elseif ($this->_tpl_vars['rs']['pnod_state'] == 18 && $this->_tpl_vars['rs']['pnod_state2'] == 1): ?>
						<li onClick="setState(<?php echo $this->_tpl_vars['rs']['proj_id']; ?>
,<?php echo $this->_tpl_vars['rs']['pnod_id']; ?>
,18.1,'pnod_state')"><a class="state<?php echo $this->_tpl_vars['rs']['pnod_state']; ?>
"><?php if ($this->_tpl_vars['rs']['pnod_day']): ?>（<?php echo $this->_tpl_vars['rs']['pnod_day']; ?>
）<?php endif; ?>【<?php echo $this->_tpl_vars['rs']['pnod_name']; ?>
】 by <?php echo $this->_tpl_vars['rs']['user_name']; ?>
<span class="stateicon stateicon_17"><?php echo $this->_tpl_vars['pnod_state_list'][$this->_tpl_vars['rs']['pnod_state']]; ?>
</span></a></li>
...
"><?php echo $this->_tpl_vars['pnod_state_list'][$this->_tpl_vars['rs']['pnod_state']]; ?>
				...
				<?php elseif ($this->_tpl_vars['rs']['pnod_state'] == 18 && $this->_tpl_vars['rs']['pnod_state2'] == 1): ?>
						<li onClick="setState(<?php echo $this->_tpl_vars['rs']['proj_id']; ?>
,<?php echo $this->_tpl_vars['rs']['pnod_id']; ?>
,18.1,'pnod_state')"><a class="state18"><?php if ($this->_tpl_vars['rs']['pnod_day']): ?>（<?php echo $this->_tpl_vars['rs']['pnod_day']; ?>
）<?php endif; ?>【<?php echo $this->_tpl_vars['rs']['pnod_name']; ?>
】 by <?php echo $this->_tpl_vars['rs']['user_name']; ?>
<span class="stateicon stateicon_17"><?php echo $this->_tpl_vars['pnod_state_list'][$this->_tpl_vars['rs']['pnod_state']]; ?>
</span></a></li>
...
')" class="del" title="删除">删除</a> 
						<?php endif; ?>
						<a onClick="updateFile('<?php echo $this->_tpl_vars['rs2']['file_id']; ?>
','<?php echo $this->_tpl_vars['rs2']['file_name']; ?>
','<?php echo $this->_tpl_vars['rs2']['pnod_id']; ?>
')" class="del" title="更新">更新</a>
...
<div id="file_update" class="popwin file_update">
	...
	<br>
	<form name="update_file_form" id="update_file_form" action="<?php echo $this->_plugins['function']['spUrl'][0][0]->__template_spUrl(array('c' => 'file','a' => 'file_update'), $this);?>
"  method="post" enctype="multipart/form-data" onSubmit="return beforeUpdate();">
