<?php /* Smarty version 2.6.26, created on 2013-04-16 10:29:30
         compiled from pg/admin/titles.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'spUrl', 'pg/admin/titles.html', 15, false),)), $this); ?>
<!DOCTYPE html>
<html lang="zh"> 
<head>
<meta charset="utf-8">
...
<thead>
  ...
  <?php $_from = $this->_tpl_vars['titlelist']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }$this->_foreach['table'] = array('total' => count($_from), 'iteration' => 0);
...
?>
  <tr>
    ...
    <td class="bright"><?php if ($this->_tpl_vars['isManager']): ?><a href="javascript:;" class="del-btn" data-id="<?php echo $this->_tpl_vars['rs']['title_id']; ?>
" data-name="<?php echo $this->_tpl_vars['rs']['title_name']; ?>
">删除</a>&nbsp;<a href="<?php echo $this->_plugins['function']['spUrl'][0][0]->__template_spUrl(array('c' => 'pgadmin','a' => 'titleEdit','title_id' => $this->_tpl_vars['rs']['title_id']), $this);?>
">修改</a><?php endif; ?></td>
  </tr>
