<?php /* Smarty version 2.6.26, created on 2013-07-15 17:45:54
...
-<a style="text-decoration:none" href="<?php echo $this->_plugins['function']['spUrl'][0][0]->__template_spUrl(array('c' => 'project_bll','a' => 'project_show','id' => $this->_tpl_vars['rs']['proj_id']), $this);?>
"><?php echo $this->_tpl_vars['rs']['proj_name']; ?>
</a></span>”顺利结束，我在项目中平均delay<span style="color: #B94A48"><?php if ($this->_tpl_vars['rs']['delay'] == null || $this->_tpl_vars['rs']['delay'] < 0): ?>0<?php else: ?><?php echo $this->_tpl_vars['rs']['delay']; ?>
<?php endif; ?>天</span>。
