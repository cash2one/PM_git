<?php /* Smarty version 2.6.26, created on 2013-07-11 10:23:39
         compiled from project/projectCheck.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'spUrl', 'project/projectCheck.html', 32, false),array('modifier', 'default', 'project/projectCheck.html', 54, false),)), $this); ?>
<!DOCTYPE html>
<html lang="zh"> 
<head>
...
" id="psdUrl"></dd>
				<dt>预览机地址:</dt>
				<dd class="url"><input id="preview_address" type="text" value="<?php echo $this->_tpl_vars['rs']['preview_address']; ?>
"/></dd>
                <dt>rd地址:</dt>
                <dd class="url"><input id="proj_rdUrl" type="text" value="<?php echo $this->_tpl_vars['rs']['proj_rdUrl']; ?>
"/></dd>
				<dt>项目目标：</dt>
