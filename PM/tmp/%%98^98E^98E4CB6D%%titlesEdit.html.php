<?php /* Smarty version 2.6.26, created on 2013-06-08 10:54:42
         compiled from pg/admin/titlesEdit.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'spUrl', 'pg/admin/titlesEdit.html', 22, false),)), $this); ?>
<!DOCTYPE html>
<html lang="zh"> 
<head>
<meta charset="utf-8">
...
<body class="pgAdmin pgAdminTitleEdit titles">
<?php $_smarty_tpl_vars = $this->_tpl_vars;
...
<section class="search">
	<h1>
	<?php if ($this->_tpl_vars['titlelist']): ?>    
            	修改 - 称谓
     <?php else: ?>
     			添加 - 称谓 
     <?php endif; ?>
