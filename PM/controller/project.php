...
class project extends spController
{
    ...
    function show()
    {
        ...
        //$type=$this->spArgs('type','1');//2-今天要完成的 3-延期的  10-组内 100-redmine 1000-组内
        $type=$this->spArgs('type','1');//1-全部  10-网站组内 100-redmine 1000-小组组内
        ...
        switch($type)
        {
            ...
            */
            ...
            default:
                ...
                {
                    case "2":
                        $condition.= '  proj_state in(20,40) and (TO_DAYS(NOW())-TO_DAYS(proj_end))>=0';
                        break;
                    case "3":
                        $condition.= '  proj_state in(20,40) and (TO_DAYS(NOW())-TO_DAYS(proj_end))>0';
                        break;
                ...
                //$condition='and proj_state in(20,40) and (TO_DAYS(NOW())-TO_DAYS(proj_end))>=0';
                if($proj_state=='a')
                {
